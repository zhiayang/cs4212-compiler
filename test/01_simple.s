...
main_dummy:
	@ spills:  <none>
	@ assigns:  '_c1' = v1;   '_t0' = v1;     'z' = v1;  '_c19' = v2;   '_c9' = v2
	@           '_t2' = v2;   '_t4' = v2;     'k' = v2;     'r' = v2;   '_c8' = v3
	@             'j' = v3;   '_c6' = v4
	stmfd sp!, {lr}
...
.main_dummy_entry:
	...
	str v2, [sp, #-4]!                      @ z = _J3Foo_3fooiiiiiE(_t0, 69, _c6, 77, _c8, _c9);
	str v3, [sp, #-4]!
	mov a1, v1
	mov a2, #69
	mov a3, v4
	...
	bl printf(PLT)
	ldr v2, =#420                           @ _c19 = 420;
	ldr a1, =.string1_raw                   @ println(_c19);
	mov a2, v2
	bl printf(PLT)
	rsb v2, v3, #1                          @ r = !j;
...
_J3Foo_3fooiiiiiE:
	@ spills:  '_c1', '_c41', '_t5', 'm', 'x', 'y'
	@ assigns:  '_c1' = v1;  '_c14' = v1;  '_c18' = v1;  '_c20' = v1;  '_c26' = v1
	@          '_c28' = v1;  '_c34' = v1;  '_c45' = v1;  '_c48' = v1;  '_c56' = v1
	@          '_c59' = v1;  '_g23' = v1;  '_g31' = v1;  '_g35' = v1;   '_g7' = v1
	@          '_t10' = v1;   '_t2' = v1;   '_t5' = v1;   '_t6' = v1;   '_t7' = v1
	@           '_t8' = v1;   '_t9' = v1;     'm' = v1;     'y' = v1;   '_t0' = v2
	@             'k' = v2;     'x' = v2;  'this' = v3;  '_c41' = v4;     'w' = v4
	stmfd sp!, {lr}
	sub sp, sp, #24
	stmfd sp!, {v1, v2, v3, v4}
	mov v3, a1
...
._J3Foo_3fooiiiiiE_entry:
	str v1, [sp, #16]                       @ spill y;
	str v2, [sp, #20]                       @ spill x;
	mov v1, #3                              @ _c1 = 3;
	str v1, [sp, #8]                        @ spill _c1;
	ldr v2, [sp, #20]                       @ restore x;
	ldr v1, [sp, #8]                        @ restore _c1;
	mul v2, v2, v1                          @ _t0 = x * _c1;
	ldr v1, [sp, #16]                       @ restore y;
	...
	bl printf(PLT)
	mov v1, #50                             @ m = 50;
	str v1, [sp, #36]                       @ spill m;
	ldr v1, =#627                           @ _c14 = 627;
	cmp v2, v1                              @ _t2 = k == _c14;
	moveq v1, #1
	movne v1, #0
...
._J3Foo_3fooiiiiiE_L2:
	ldr v1, =.string4                       @ _c18 = "omegalul";
	mov a1, v1                              @ println(_c18);
	add a1, a1, #4
	bl puts(PLT)
	mov v1, #5                              @ _c20 = 5;
	mul v2, v2, v1                          @ k = k * _c20;
	mov v1, #19                             @ _g23 = 19;
	str v1, [v3, #4]                        @ storefield: Int, *this.f2 = _g23;
	b ._J3Foo_3fooiiiiiE_L3                 @ goto .L3;
._J3Foo_3fooiiiiiE_L1:
	ldr v1, =.string5                       @ _c26 = "kekw";
	mov a1, v1                              @ println(_c26);
	add a1, a1, #4
	bl puts(PLT)
	mov v1, #2                              @ _c28 = 2;
	mul v2, v2, v1                          @ k = k * _c28;
	mov v1, #69                             @ _g31 = 69;
...
._J3Foo_3fooiiiiiE_L3:
	ldr v1, =#420                           @ _c34 = 420;
	mov v1, v1                              @ _g35 = _c34;
	str v1, [v3, #0]                        @ storefield: Int, *this.f1 = _g35;
	add v1, v4, #1                          @ _t5 = w + 1;
	str v1, [sp, #12]                       @ spill _t5;
	ldr v4, =#69420                         @ _c41 = 69420;
	str v4, [sp, #4]                        @ spill _c41;
	ldr v4, [sp, #4]                        @ restore _c41;
	ldr v1, [sp, #12]                       @ restore _t5;
	cmp v1, v4                              @ _t6 = _t5 != _c41;
	movne v1, #1
	moveq v1, #0
...
._J3Foo_3fooiiiiiE_L5:
	ldr v1, =.string6                       @ _c45 = "sadge";
	mov a1, v1                              @ println(_c45);
	add a1, a1, #4
	bl puts(PLT)
	b ._J3Foo_3fooiiiiiE_L6                 @ goto .L6;
._J3Foo_3fooiiiiiE_L4:
	ldr v1, =.string7                       @ _c48 = "poggers";
	mov a1, v1                              @ println(_c48);
	add a1, a1, #4
	bl puts(PLT)
	b ._J3Foo_3fooiiiiiE_L6                 @ goto .L6;
._J3Foo_3fooiiiiiE_L6:
	ldr v1, [sp, #36]                       @ restore m;
	cmp v1, #50                             @ _t7 = m == 50;
	moveq v1, #1
	movne v1, #0
...
._J3Foo_3fooiiiiiE_L8:
	ldr v1, =.string8                       @ _c56 = "riperino";
	mov a1, v1                              @ println(_c56);
	add a1, a1, #4
	bl puts(PLT)
	b ._J3Foo_3fooiiiiiE_L9                 @ goto .L9;
._J3Foo_3fooiiiiiE_L7:
	ldr v1, =.string9                       @ _c59 = "poggerino";
	mov a1, v1                              @ println(_c59);
	add a1, a1, #4
	bl puts(PLT)
	b ._J3Foo_3fooiiiiiE_L9                 @ goto .L9;
